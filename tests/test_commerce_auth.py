...
class CommerceAuthTests(unittest.TestCase):
    ...
    def test_journey_renders_new_funnel_workspace_and_assets(self):
        ...
        self.assertIn('/static/funnel-analysis.css?v=2',response.text)
        self.assertIn('/static/funnel-analysis.js?v=2',response.text)
        self.assertIn('/static/heatmap-analysis.css?v=2',response.text)
