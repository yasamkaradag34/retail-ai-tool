...
class CommerceAuthTests(unittest.TestCase):
    ...
    def test_category_workspace_requires_real_ga4_instead_of_auto_sample(self):
        ...
        self.assertIn('/static/category-analysis.css?v=3', response.text)
        self.assertIn('/static/category-analysis.js?v=3', response.text)
        self.assertIn('class="ca-command-bar"', response.text)
        self.assertIn('class="ca-date-actions"', response.text)
        self.assertIn('id="caTransactionChart"', response.text)
        self.assertIn('id="caPdpDonut"', response.text)
        self.assertIn('Category revenue distribution', response.text)
    ...
    def test_journey_renders_new_funnel_workspace_and_assets(self):
        ...
        self.assertIn('/static/funnel-analysis.css?v=3',response.text)
        self.assertIn('/static/funnel-analysis.js?v=3',response.text)
        self.assertIn('/static/heatmap-analysis.css?v=3',response.text)
        ...
        self.assertIn('id="faLandingPrevious"',response.text)
        self.assertIn('id="hmElementsPrevious"',response.text)
        self.assertIn('id="hmFormsPrevious"',response.text)
        self.assertIn('id="excelPreviewPrevious"',response.text)
        self.assertIn('id="disconnectGoogleBtn"',response.text)
